    ...
    <>
      ...
      <contextVar.Provider value={contextData}>
        <BrowserRouter>
          ...
          <div
            className={`sm:w-full transition-all pl-4 pr-4 md:pl-8 ${boxWidth.width}  ${boxWidth.margin} mt-2 h-screen overflow-y-scroll`}
          >
            ...
            <Routes>
              ...
              <Route
                path="/trade-payment-receipt"
                element={<PaymentReceipt />}
              />
              <Route
                path="/trade-provisional-license"
                element={<ProvisionalLicense />}
              />
              {/* trade routes */}
            ...
            <Route path="/objection-assessment-error" element={<ObjectionFormIndex/>} />
              ...
              <Route
                path="/da-verify"
                element={<PropertySafDocumentVerify />}
              />
              ...
              <Route
                path="/ulb-workflow-roles"
                element={<UlbWorkflowRolesIndex />}
              />
              ...
              <Route
                ...
                element={<Dashboard_Advertisement />}
              />
