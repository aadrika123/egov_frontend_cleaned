...
function EditUserRole(props) {
    ...
    const [roleDescription, setRoleDescription] = useState(data?.role_description)
    ...
    const { isLoading, data: newData, isError, error } = useQuery("GetULbListINEditUser", () => {
        ...
        <>
            <div>
                ...
                <div className='mt-3 flex justify-center'>
                    <button onClick={savebtnClick} className='bg-green-400 hover:bg-green-600 px-2 py-1 mx-1 rounded-sm font-medium'>Save</button>
                    <button onClick={closeDialoge} className='bg-red-400 hover:bg-red-600 px-2 py-1 mx-1 rounded-sm font-medium'>Cancel</button>
                </div>
            </div>
