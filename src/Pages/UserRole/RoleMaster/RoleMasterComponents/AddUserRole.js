...
function AddUserRole(props) {
    ...
    const { isLoading, data, isError, error } = useQuery("GetULBLIstFromAPIForAddUser", () => {
    ...
    return (
        <>
            <div className='flex flex-col items-center'>
                ...
                <div className='mt-3 '>
                    <button onClick={handleSaveBtn} className='bg-green-400 hover:bg-green-600 px-2 py-1 mx-1 rounded-sm font-medium'>Add Role</button>
