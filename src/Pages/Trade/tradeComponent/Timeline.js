            ...
            <div class="mx-6 p-4 m-2">
                <div class="flex items-center ">
                    <div class="flex items-center text-gray-500 relative">
                        ...
                        <div className={` ${currentPage1} absolute top-0 -ml-10 text-center mt-14 w-32 text-xs uppercase text-teal-600`}>Basic </div>
                    </div>
                    ...
                    <div class="flex items-center text-gray-500 relative">
                        ...
                        <div className={` ${currentPage2} absolute top-0 -ml-10 text-center mt-14 w-32 text-xs uppercase text-teal-600`}>Firm </div>
                    </div>
                    ...
                    <div class="flex items-center text-gray-500 relative">
                        ...
                        <div className={` ${currentPage3} absolute top-0 -ml-10 text-center mt-14 w-32 text-xs uppercase text-teal-600`}>Owner </div>
                    </div>
                    ...
                    <div class="flex items-center text-gray-500 relative">
                        ...
                        <div className={` ${currentPage4} absolute top-0 -ml-10 text-center mt-14 w-32 text-xs uppercase text-teal-600`}>Payment </div>
                    </div>
                    ...
                    <div class="flex items-center text-gray-500 relative">
                        ...
                        <div className={` ${currentPage5} absolute top-0 -ml-10 text-center mt-14 w-32 text-xs uppercase text-teal-600`}>Document </div>
                    </div> */}
