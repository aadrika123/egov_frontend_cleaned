    ...
    return (
        <>
            ...
            <div className="grid grid-cols-12 rounded-lg mt-0 -ml-10 shadow-xl broder-2 border-sky-200 bg-gray-200">
                ...
                {tabIndex == 0 && <div className='col-span-12 sm:col-span-10 shadow-lg bg-white overflow-y-scroll' style={{ 'height': '90vh' }}><TradeListBox workflowCandidates={workflowCandidate} boxType="inbox" boxUrl="http://192.168.0.166/api/property/saf/inbox" /></div>}
                {tabIndex == 1 && <div className='col-span-12 sm:col-span-10 shadow-lg bg-white overflow-y-scroll' style={{ 'height': '90vh' }}><TradeListBox boxType="outbox" boxUrl="http://192.168.0.166/api/saf-out" /></div>}
                {tabIndex == 2 && <div className='col-span-12 sm:col-span-10 shadow-lg bg-white overflow-y-scroll' style={{ 'height': '90vh' }}><Search /></div>}
                {tabIndex == 3 && <div className='col-span-12 sm:col-span-10 shadow-lg bg-white overflow-y-scroll' style={{ 'height': '90vh' }}><TradeListBox workflowCandidates={workflowCandidate} boxType="specialbox" boxUrl="http://192.168.0.166/api/property/saf/escalate/inbox" /></div>}
