    ...
    const getLicenseData = (licenseNo) => {
        ...
        axios.post(TRADE.SEARCH_LICENSE_FOR_APPLY, { licenceNo: licenseNo, applicationType:applicationType }, HEADER())
            .then(function (response) {
                console.log('license data for surrender', response);
    ...
    return (
        <>
            <div className={`block p-4 w-full md:py-6`} >
                <h1 className=' mb-2 font-serif font-semibold  text-gray-600'><FaHome className="inline mr-2" />Search License For Surrender</h1>
                ...
                <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={onSubmit}>
                    <Form onChange={handleOnChange} autoComplete="off">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-2  border-teal-800 mb-2 ">
                            {/* <div className=""> */}
