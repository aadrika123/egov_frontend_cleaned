...
export default function PropertySafDetailsTabs(props) {
    ...
    const fetchDetailsById = () => {
        ...
        axios.post(`${api_getSafDetailsById}`, { id: props.id }, header)
    ...
    return (
        <>
            ...
            <div>
                ...
                {props.boxTypeFun != true && showTabs ? <div className=' '>
                    <Box sx={{ width: '100%' }}>
                        ...
                        <TabPanel value={value} index={1}>
                            ...
                            <PropertySafWorkflowTimeline toast={notify} applicationData={applicationData} members={props.members} showTabFun={setshowTabs} />
                        </TabPanel>
