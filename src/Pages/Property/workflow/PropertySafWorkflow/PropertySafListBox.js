    ...
    <>
      ...
      <Box sx={{ width: '100%' }}>
        ...
        <TabPanel value={value} index={0}>
          {(props.boxType == 'inbox') && <PropertySafInboxList boxType={props.boxType} boxUrl={props.boxUrl} fun={viewDetails} />}
          {(props.boxType == 'outbox') && <PropertySafOutboxList boxType={props.boxType} boxUrl={props.boxUrl} fun={viewDetails} />}
          {(props.boxType == 'specialbox') && <PropertySafSpecialList boxType={props.boxType} boxUrl={props.boxUrl} fun={viewDetails} />}
        ...
        <TabPanel value={value} index={1}>
          <PropertySafDetailsTabs fun={handleChange} id={listId} members={props.workflowCandidates} boxTypeFun={props.boxType == 'outbox'}/>   {/**PropertySafDetailsTabs to show details of selected application */}
        </TabPanel>
