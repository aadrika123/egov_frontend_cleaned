...
//    Revision - 1
//    Project - JUIDCO
//    Component  - PropertyConcessionDocumentView (closed)
//    DESCRIPTION - PropertyConcessionDocumentView Component

import { useState } from 'react'
import PropertyConcessionDocumentRow from "./PropertyConcessionDocumentRow"
...
function PropertyConcessionDocumentView() {
                                ...
                                <tbody>
                                    {
                                        docList.map((data, index) => (
                                            <PropertyConcessionDocumentRow openModal={modalAction} docList={data} index={index} />
                                        ))
                                    }
...
export default PropertyConcessionDocumentView
/**
 * Exported to :
