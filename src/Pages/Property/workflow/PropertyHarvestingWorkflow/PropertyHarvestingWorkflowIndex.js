...
//    Revision - 1
//    Project - JUIDCO
//    Component  - PropertyHarvestingWorkflowIndex (closed)
//    DESCRIPTION - PropertyHarvestingWorkflowIndex Component
//////////////////////////////////////////////////////////////////////////////////////
...
import PropertyHarvestingInbox from './PropertyHarvestingInbox'


function PropertyHarvestingWorkflowIndex() {
    ...
    return (
        <>
            ...
            {/* <div className="grid grid-cols-12 mb-2">
                <div className='bg-sky-100 border-l border-b border-white text-black col-span-12 sm:col-span-3 sm:col-start-10 pl-4 rounded-l shadow-lg font-semibold'><TbWebhook className='inline' /> Harvesting WorkFlow</div>
            </div> */}
            <div className="grid grid-cols-12 rounded-lg mt-0 -ml-10 shadow-xl broder-2 border-sky-200 bg-gray-200">
                ...
                {tabIndex == 0 && <div className='col-span-12 sm:col-span-10 shadow-lg bg-white overflow-y-scroll' style={{ 'height': '90vh' }}><PropertyHarvestingInbox /></div>}       {/**PropertySafInbox  component to show list of all incoming holding applications */}
...
export default PropertyHarvestingWorkflowIndex
/**
 * Exported to :
 * 1. App.js
 * 
