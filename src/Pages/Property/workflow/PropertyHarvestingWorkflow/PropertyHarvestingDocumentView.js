...
//    Revision - 1
//    Project - JUIDCO
//    Component  - PropertyHarvestingDocumentView (closed)
//    DESCRIPTION - PropertyHarvestingDocumentView Component

import { useState } from 'react'
import PropertyHarvestingDocumentRow from "./PropertyHarvestingDocumentRow"
...
function PropertyHarvestingDocumentView() {
                                ...
                                <tbody>
                                    {
                                        docList.map((data, index) => (
                                            <PropertyHarvestingDocumentRow openModal={modalAction} docList={data} index={index} />
                                        ))
                                    }
...
export default PropertyHarvestingDocumentView
/**
 * Exported to :
