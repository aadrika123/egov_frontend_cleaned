...
//    Revision - 1
//    Project - JUIDCO
//    Component  - PropertyHarvestingDetailsCard (closed)
//    DESCRIPTION - PropertyHarvestingDetailsCard Component
//////////////////////////////////////////////////////////////////////////////////////
import { useState } from 'react'
import propImage from './prop.jpg'
import { GrHomeRounded } from 'react-icons/gr'
import Modal from 'react-modal';
import PropertyHarvestingFullDetailsCard from './PropertyHarvestingFullDetailsCard';
...
function PropertyHarvestingDetailsCard(props) {
            ...
            >
                ...
                <div class="rounded-lg  shadow-xl pt-4 bg-gray-400 ml-40" style={{ 'width': '70vw', 'height': '70vh' }}>
                    <div className='bg-gray-400'>
                        <PropertyHarvestingFullDetailsCard />
                        <PropertyHarvestingFullDetailsCard />
                        <PropertyHarvestingFullDetailsCard />
                    </div>
                </div>
...
export default PropertyHarvestingDetailsCard
/**
 * Exported to :
