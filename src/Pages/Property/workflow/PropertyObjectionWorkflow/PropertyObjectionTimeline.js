...
//    Revision - 1
//    Project - JUIDCO
//    Component  - PropertyObjectionTimeline (closed)
//    DESCRIPTION - PropertyObjectionTimeline Component
//////////////////////////////////////////////////////////////////////////////////////
import React from 'react'
import { useQuery } from "react-query";
import axios from 'axios'
import PropertyObjectionTimelineCards from './PropertyObjectionTimelineCards';
...
function PropertyObjectionTimeline() {
    ...
    return (
        <>
            <h1 className='text-center bg-sky-100 h-10 grid items-center font-semibold'>Timeline</h1>
            <div className="container bg-white mx-auto w-full h-full">
                <div className="relative wrap overflow-hidden p-10 h-full">
                    <div className="border-2-2 absolute border-opacity-20 border-gray-700 h-full border border-red-600" style={{"left": "50%"}}></div>
                    ...
                    <PropertyObjectionTimelineCards/>
                    <PropertyObjectionTimelineCards/>
                    <PropertyObjectionTimelineCards/>
                </div>
            </div>
...
export default PropertyObjectionTimeline
/**
 * Exported to :
 * 1 PropertyObjectionWorkflowTimeLine Component
 * 
 */