...
function SafApplicationFormIndex() {
    ...
    const submitSafForm = () => {
        ...
        // return
        axios.post(`${api_getPostSafFormData()}/NewAssessment`, requestBody, header)
    ...
    useEffect(() => {
        ...
        axios.get(`${api_getPostSafFormData()}/NewAssessment`, header)
            .then(function (response) {
    ...
    return (
        <>
            ...
            {formIndex < 7 && <>
                <div className={`${animateform1} transition-all relative`}><BasicDetails preFormData={preFormData} collectFormDataFun={collectAllFormData} toastFun={notify} backFun={backFun} nextFun={nextFun} /></div>
                ...
                <div className={`${animateform2} transition-all relative`}><PropertyAddressDetails preFormData={preFormData} collectFormDataFun={collectAllFormData} toastFun={notify} backFun={backFun} nextFun={nextFun} /></div>
                <div className={`${animateform3} transition-all relative`}><ElectricityWaterDetails preFormData={preFormData} collectFormDataFun={collectAllFormData} backFun={backFun} nextFun={nextFun} /></div>
                <div className={`${animateform4} transition-all relative`}><OwnerDetails preFormData={preFormData} assType={assTypeText} collectFormDataFun={collectAllFormData} toastFun={notify} backFun={backFun} nextFun={nextFun} /></div>
                <div className={`${animateform5} transition-all relative`}><FloorDetails preFormData={preFormData} collectFormDataFun={collectAllFormData} submitStatus={submitStatus} toastFun={notify} backFun={backFun} nextFun={nextFun} /></div>
