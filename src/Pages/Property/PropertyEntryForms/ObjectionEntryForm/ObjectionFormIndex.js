...
function ObjectionFormIndex() {
    ...
    return (
        <>
            ...
            <div className={`${animateform1} transition-all relative`}><ObjectionEntryForm collectFormDataFun={collectAllFormData} submitFun={submitButtonToggle} toastFun={notify} /></div>
