...
function TcVerificationForm2(props) {
    ...
    return (
        <>
            ...
            <div className="absolute top-0 overflow-x-auto">
                <h1 className='px-4 font-semibold font-serif'><img src={verified} alt="pin" className='w-6 inline' /> TC Verification</h1>
                    ...
                    <div className="w-full lg:w-4/6">
                        ...
                        <div className="col-span-5 grid grid-cols-3">
                            ...
                            <div className='md:pl-10 text-right'>
                                <button onClick={()=>props.nextFun(1)} type="button" className=" px-6 py-2.5 bg-green-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Save</button>
                            </div>
...
export default TcVerificationForm2