...
import ElectricityWaterDetails from './GovSafBasicDetails.js'
import PropertyAddressDetails from './GovSafOwner'
import OwnerDetails from './OwnerDetails'
import FloorDetails from './GovSafFloor'
import { ToastContainer, toast } from 'react-toastify';
import 'react-toastify/dist/ReactToastify.css';
import { ImUpload2 } from 'react-icons/im'
import FormSubmitResponse from 'Components/Common/ResponseScreen/FormSubmitResponse'
import GovSafBasicDetails from './GovSafBasicDetails.js'
...
function GovSafApplicationFormIndex() {
    ...
    return (
        <>
            ...
            <div className={`${animateform1} transition-all relative`}><GovSafBasicDetails collectFormDataFun={collectAllFormData} submitFun={submitButtonToggle} toastFun={notify} backFun={backFun} nextFun={nextFun} /></div>
