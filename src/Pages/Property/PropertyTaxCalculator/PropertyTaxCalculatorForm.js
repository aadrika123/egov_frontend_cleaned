...
function PropertyTaxCalculatorForm(props) {
    ...
    const onSubmit = (values, resetForm) => {
        ...
        props.collectFormDataFun('PropertyTaxCalculatorForm', values) //sending PropertyTaxCalculatorForm data to parent to store all form data at one container
    ...
    return (
        <>
            ...
            <div className="block p-4 w-full md:pb-6 shadow-lg bg-white border border-gray-200  mx-auto absolute">
                <div className='bg-green-400 h-36 flex justify-center items-center font-serif shadow-lg mb-6 border-b border-white relative'>
                    <span className='text-center text-white text-3xl font-semibold'> Calculate your holding tax anytime</span>
                    {/* </div> */}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4">
                            <div className="col-span-4 grid grid-cols-1 md:grid-cols-7">
                                ...
                                <div className={`${inputContainerStyle}`}>
                                    ...
                                    <Field name="plotArea" type="text" className={`${commonInputStyle} cursor-pointer `}
                                    />
                                    <span className={`${inputErrorStyle}`}>                                   <ErrorMessage name='plotArea' />
                                    </span>
                                </div>
                                <div className={`${inputContainerStyle}`}>
                                    <label className={`${inputLabelStyle}`}>Road-Width</label>
                                    <Field name="roadWidth" type="text" className={`${commonInputStyle} cursor-pointer `}
                                    />
                                    <span className={`${inputErrorStyle}`}>                                   <ErrorMessage name='roadWidth' />
                                    </span>
                                </div>
                            </div>
                            <div className={`${inputContainerStyle}`}>
                            ...
                            {/* <div className={`col-span-4 md:col-span-3 ${mobileTowerStatusToggle ? 'grid' : 'hidden'} grid-cols-1 md:grid-cols-3`}>
                                <div className={`${inputContainerStyle}`}>
                                    ...
                                    <Field disabled name="mobileTowerArea" type="text" className={`${commonInputStyle} `} />
                ...
                <PropertyTaxFloorForm />

                <div className='md:px-10 text-right'>
                    <button onClick={() => props.nextFun(1)} type="button" className=" px-6 py-2.5 bg-green-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-green-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-green-800 active:shadow-lg transition duration-150 ease-in-out">Save<BiAddToQueue className=' hidden md:inline font-semibold text-sm md:text-lg' /></button>
                </div>
            </div>
