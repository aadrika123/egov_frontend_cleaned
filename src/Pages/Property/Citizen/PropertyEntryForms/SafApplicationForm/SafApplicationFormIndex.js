...
function SafApplicationFormIndex() {
    ...
    const backFun = (formIndex) => {
        ...
        if (tempFormIndex == 2) { //backward by current form index 2
            ...
            setAnimateform1('translate-x-0 mb-40') // always setstate one index less than current index
            setAnimateform2('pl-20 translate-x-full mb-0') //always current index setstate
        }
        if (tempFormIndex == 3) {
            setFormIndex(2)
    ...
    const nextFun = (formIndex) => {
        ...
        if (tempFormIndex == 1) { //forward by current form index 1
            ...
            setAnimateform1(' -translate-x-full right-80 mb-0')  //always current index setstate
            setAnimateform2('pl-0 translate-x-0 mb-40') // always setstate one index greater than current index
        }
        if (tempFormIndex == 2) {
            setFormIndex(3)
        ...
        <>
            ...
            <div className="grid grid-cols-2">
                ...
                <div><div className='text-right relative top-0 animate__animated animate__fadeInDown'>
                    <span className='bg-sky-100 border-l border-b border-white text-black col-span-12 sm:col-span-2 sm:col-start-11 pl-4 rounded-l shadow-lg font-semibold pr-4'><TbWebhook className='inline' /> {assTypeText} ct</span>
                </div></div>
            </div>
            ...
            <div className={`${animateform1} transition-all relative`}><BasicDetails collectFormDataFun={collectAllFormData} submitFun={submitButtonToggle} toastFun={notify} backFun={backFun} nextFun={nextFun} /></div>
            ...
            <div className={`${animateform2} transition-all relative`}><PropertyAddressDetails collectFormDataFun={collectAllFormData} submitFun={submitButtonToggle} toastFun={notify} backFun={backFun} nextFun={nextFun} /></div>
            <div className={`${animateform3} transition-all relative`}><ElectricityWaterDetails collectFormDataFun={collectAllFormData} submitFun={submitButtonToggle} backFun={backFun} nextFun={nextFun} /></div>
            <div className={`${animateform4} transition-all relative`}><OwnerDetails  assType={assTypeText} collectFormDataFun={collectAllFormData} submitFun={submitButtonToggle} toastFun={notify} backFun={backFun} nextFun={nextFun} /></div>
            <div className={`${animateform5} transition-all relative`}><FloorDetails collectFormDataFun={collectAllFormData} submitFun={submitButtonToggle} toastFun={notify} backFun={backFun} nextFun={nextFun} /></div>
