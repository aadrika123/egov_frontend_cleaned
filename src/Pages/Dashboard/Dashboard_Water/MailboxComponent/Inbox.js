...
import InboxDetailsTabs from './InboxDetailsTabs'
    ...
    <>
      ...
      <Box sx={{ width: '100%' }}>
        ...
        <TabPanel value={value} index={0}>
          <InboxListItems fun={viewDetails} />   {/**ListItem component to show list of application in table */}
        </TabPanel>
        <TabPanel value={value} index={1}>
          <InboxDetailsTabs id={listId} />   {/**detailstabs to show details of selected application */}
        </TabPanel>
