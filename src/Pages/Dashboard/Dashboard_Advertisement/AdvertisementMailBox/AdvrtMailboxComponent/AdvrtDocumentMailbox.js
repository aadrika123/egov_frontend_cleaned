...
//    Revision - 1
//    Project - JUIDCO
//    Component  - AdvrtDocumentMailbox
//    DESCRIPTION - AdvrtDocumentMailbox Component
//////////////////////////////////////////////////////////////////////////////////////


import { useState } from 'react'
import Modal from 'react-modal';
import AdvrtDocumentRowMailbox from './AdvrtDocumentRowMailbox.js';
                        ...
                        <div className="inline-block min-w-full rounded-lg overflow-hidden">
                            <table className="min-w-full leading-normal">
                                ...
                                <tbody>
                                    ...
                                    <AdvrtDocumentRowMailbox openModal={modalAction} index="1" documentName="Aadhaar" status="Rejected" remarks="Document is not correct" />
                                    <AdvrtDocumentRowMailbox openModal={modalAction} index="1" documentName="Aadhaar" status="Rejected" remarks="Document is not correct" />
                                    <AdvrtDocumentRowMailbox openModal={modalAction} index="1" documentName="Aadhaar" status="Rejected" remarks="Document is not correct" />
                                    <AdvrtDocumentRowMailbox openModal={modalAction} index="1" documentName="Aadhaar" status="Rejected" remarks="Document is not correct" />
...
export default AdvrtDocumentMailbox