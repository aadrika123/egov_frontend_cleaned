...
//    Revision - 1
//    Project - JUIDCO
//    Component  - AdvrtListItems
//    DESCRIPTION - AdvrtListItems Component
//////////////////////////////////////////////////////////////////////////////////////
...
import AdvrtGlobalFilter from './AdvrtGlobalFilter.js';

function AdvrtListItems(props) {
    ...
    return (
        <>
            <div className="flex mb-2 pb-2">
                <div className='flex-initial'><AdvrtGlobalFilter filter={globalFilter} setFilter={setGlobalFilter} /></div>
