...
//    Revision - 1
//    Project - JUIDCO
//    Component  - WaterDetailsWorkflow
//    DESCRIPTION - WaterDetailsWorkflow Component
//////////////////////////////////////////////////////////////////////////////////////
import { useState,useEffect } from 'react'
import WaterWorkflowDetailsCard from './WaterWorkflowMaster/WaterWorkflowDetailsCard'
...
import WaterWorkFlowTrack from './WaterWorkflowMaster/WaterWorkFlowTrack';
...
function DetailsWorkflow(props) {
    ...
    useEffect(() => {
        axios.get(`http://localhost:3001/workflowList/${props.id}`)
        ...
        <>
            ...
            <Box sx={{ width: '100%' }}>
                ...
                <TabPanel value={value} index={0}>
                    <Candidates workflowDetailsData={workflowDetailsData} />
                </TabPanel>
