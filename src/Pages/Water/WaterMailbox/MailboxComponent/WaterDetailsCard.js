...
//    Revision - 1
//    Project - JUIDCO
//    Component  - WaterDetailsCard
//    DESCRIPTION - WaterDetailsCard Component
//////////////////////////////////////////////////////////////////////////////////////
...
import WaterFullDetialsCard from './WaterFullDetialsCard';
                    ...
                    <div className="md:flex no-wrap md:-mx-2 ">
                        <div className="w-full md:w-3/12 md:mx-2 shadow-xl">
                            <div className="bg-white p-3 border-t-4 border-green-400">
                                ...
                                <h1 className="text-gray-900 font-bold text-x text-center leading-8 my-1">Water Connection</h1>
                        ...
                        <div className="w-full md:w-9/12 mx-2 h-auto">
                            <div className="bg-white p-3 shadow-xl rounded-sm">
                                <div className="flex items-center pl-4 space-x-2 font-semibold text-gray-900 leading-8">
                                    ...
                                    <span className="tracking-wide">About Water Supply</span>
                                </div>
