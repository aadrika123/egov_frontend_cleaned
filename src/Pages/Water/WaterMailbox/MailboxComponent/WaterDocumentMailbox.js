...
//    Revision - 1
//    Project - JUIDCO
//    Component  - WaterDocumentMailbox
//    DESCRIPTION - WaterDocumentMailbox Component
//////////////////////////////////////////////////////////////////////////////////////
import { useState } from 'react'
import WaterDocumentRowMailbox from './WaterDocumentRowMailbox'
                        ...
                        <div className="inline-block min-w-full rounded-lg overflow-hidden">
                            <table className="min-w-full leading-normal">
                                ...
                                <tbody>
                                    ...
                                    <WaterDocumentRowMailbox openModal={modalAction} index="1" documentName="Aadhaar" status="Rejected" remarks="Document is not correct" />
                                    <WaterDocumentRowMailbox openModal={modalAction} index="1" documentName="Aadhaar" status="Rejected" remarks="Document is not correct" />
                                    <WaterDocumentRowMailbox openModal={modalAction} index="1" documentName="Aadhaar" status="Rejected" remarks="Document is not correct" />
                                    <WaterDocumentRowMailbox openModal={modalAction} index="1" documentName="Aadhaar" status="Rejected" remarks="Document is not correct" />
