...
import WaterGlobalFilter from './WaterGlobalFilter.js'
import { format } from 'date-fns'
import axios from 'axios'
import { AiOutlineDoubleRight, AiOutlineDoubleLeft } from 'react-icons/ai'
import { baseUrl } from '../WaterBaseUrl.js';
...
function BasicTable(props) {
    ...
    const fetchAppList = () => {
        axios.get(`${baseUrl}/applicationList`)
    ...
    return (
        <>
            ...
            <div className="flex mb-2 pb-2">
                <div className='flex-initial'><WaterGlobalFilter filter={globalFilter} setFilter={setGlobalFilter} /></div>
