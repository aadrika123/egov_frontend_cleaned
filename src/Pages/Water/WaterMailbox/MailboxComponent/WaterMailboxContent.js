...
//    Revision - 1
//    Project - JUIDCO
//    Component  - WaterMailboxContent
//    DESCRIPTION - WaterMailboxContent Component
//////////////////////////////////////////////////////////////////////////////////////
    ...
    <>
      ...
      <Box sx={{ width: '100%' }}>
        ...
        <TabPanel value={value} index={0}>
          <WaterListItems fun={viewDetails} />   {/**ListItem component to show list of application in table */}
        </TabPanel>
        <TabPanel value={value} index={1}>
          <WaterDetailsTabs id={listId} />   {/**detailstabs to show details of selected application */}
        </TabPanel>
