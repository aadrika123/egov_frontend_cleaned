...
//    Revision - 1
//    Project - JUIDCO
//    Component  - PvtDetailsTable
//    DESCRIPTION - PvtDetailsTable Component
//////////////////////////////////////////////////////////////////////////////////////
...
import PvtDetailsCard from './PvtDetailsCard.js'

function PvtDetailsTable(data) {
    ...
    return (
        <>
            <PvtDetailsCard applicationData={applicationData} />
        </>
    )
}

export default PvtDetailsTable