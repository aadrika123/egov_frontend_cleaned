...
//    Revision - 1
//    Project - JUIDCO
//    Component  - PvtDocumentMailbox
//    DESCRIPTION - PvtDocumentMailbox Component
//////////////////////////////////////////////////////////////////////////////////////


import { useState } from 'react'
import Modal from 'react-modal';
import PvtDocumentRowMailbox from './PvtDocumentRowMailbox.js';
                        ...
                        <div className="inline-block min-w-full rounded-lg overflow-hidden">
                            <table className="min-w-full leading-normal">
                                ...
                                <tbody>
                                    ...
                                    <PvtDocumentRowMailbox openModal={modalAction} index="1" documentName="Aadhaar" status="Rejected" remarks="Document is not correct" />
                                    <PvtDocumentRowMailbox openModal={modalAction} index="1" documentName="Aadhaar" status="Rejected" remarks="Document is not correct" />
                                    <PvtDocumentRowMailbox openModal={modalAction} index="1" documentName="Aadhaar" status="Rejected" remarks="Document is not correct" />
                                    <PvtDocumentRowMailbox openModal={modalAction} index="1" documentName="Aadhaar" status="Rejected" remarks="Document is not correct" />
...
export default PvtDocumentMailbox