...
//    Revision - 1
//    Project - JUIDCO
//    Component  - PvtListItems
//    DESCRIPTION - PvtListItems Component
//////////////////////////////////////////////////////////////////////////////////////
...
import VehicleGlobalFilter from './PvtGlobalFilter.js';
import PvtGlobalFilter from './PvtGlobalFilter.js';

function PvtListItems(props) {
    ...
    const [applicationLIst, setApplicationLIst] = useState([{ "id": 1, "saf_no": "6466244377", "entity_name": "Tiertza", "mobile": "0601669703", "property_type": "VACANT", "assessment_type": "New Assessment", "ward_no": 1, "received_at": "10/22/2021" },
    ...
    return (
        <>
            <div className="flex mb-2 pb-2">
                <div className='flex-initial'><PvtGlobalFilter filter={globalFilter} setFilter={setGlobalFilter} /></div>
