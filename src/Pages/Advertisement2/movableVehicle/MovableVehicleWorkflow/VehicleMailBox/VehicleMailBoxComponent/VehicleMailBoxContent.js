...
//    Revision - 1
//    Project - JUIDCO
//    Component  - VehicleMailBoxContent
//    DESCRIPTION - VehicleMailBoxContent Component
//////////////////////////////////////////////////////////////////////////////////////
...
function VehicleMailBoxContent() {
        ...
        <>
            ...
            <Box sx={{ width: '100%' }}>
                ...
                <TabPanel value={value} index={0}>
                    <VehicleListItems fun={viewDetails} />   {/**ListItem component to show list of application in table */}
                </TabPanel>
                <TabPanel value={value} index={1}>
                    <VehicleDetailsTabs id={listId} />   {/**detailstabs to show details of selected application */}
                </TabPanel>
...
export default VehicleMailBoxContent