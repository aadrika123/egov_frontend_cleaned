...
//    Revision - 1
//    Project - JUIDCO
//    Component  - VehicleListItems
//    DESCRIPTION - VehicleListItems Component
//////////////////////////////////////////////////////////////////////////////////////
...
import VehicleGlobalFilter from './VehicleGlobalFilter.js';

function VehicleListItems(props) {
    ...
    return (
        <>
            <div className="flex mb-2 pb-2">
                <div className='flex-initial'><VehicleGlobalFilter filter={globalFilter} setFilter={setGlobalFilter} /></div>
