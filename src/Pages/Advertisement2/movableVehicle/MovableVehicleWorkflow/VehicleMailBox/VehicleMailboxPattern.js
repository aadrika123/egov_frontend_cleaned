...
//    Revision - 1
//    Project - JUIDCO
//    Component  - VehicleMailboxPattern
//    DESCRIPTION - VehicleMailboxPattern Component
//////////////////////////////////////////////////////////////////////////////////////
...
import VehicleMailBoxSidebar from './VehicleMailBoxComponent/VehicleMailBoxSidebar'
import VehicleMailBoxContent from './VehicleMailBoxComponent/VehicleMailBoxContent'

function VehicleMailboxPattern() {
    ...
    return (
        <>
            <div className="grid grid-cols-12 rounded-lg mt-4 -ml-10 shadow-xl broder-2 border-sky-200 bg-gray-200">
                <div className='col-span-12 sm:col-span-2 '> <VehicleMailBoxSidebar fun={tabSwitch} /></div>
                {tabIndex == 0 && <div className='col-span-12 sm:col-span-10 shadow-lg bg-white overflow-y-scroll' style={{ 'height': '90vh' }}><VehicleMailBoxContent /></div>}       {/**input box component to show list of all incoming holding applications */}
...
export default VehicleMailboxPattern
/**
 * Exported to :
