...
//    Revision - 1
//    Project - JUIDCO
//    Component  - AgencyListItems
//    DESCRIPTION - AgencyListItems Component
//////////////////////////////////////////////////////////////////////////////////////
...
import AgencyGlobalFilter from './AgencyGlobalFilter.js';

function AgencyListItems(props) {
    ...
    return (
        <>
            <div className="flex mb-2 pb-2">
                <div className='flex-initial'><AgencyGlobalFilter filter={globalFilter} setFilter={setGlobalFilter} /></div>
...
export default AgencyListItems