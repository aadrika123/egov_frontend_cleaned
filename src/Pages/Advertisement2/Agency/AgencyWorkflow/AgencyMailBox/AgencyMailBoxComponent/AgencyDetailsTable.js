...
//    Revision - 1
//    Project - JUIDCO
//    Component  - AgencyDetailsTable
//    DESCRIPTION - AgencyDetailsTable Component
//////////////////////////////////////////////////////////////////////////////////////
...
import AgencyDetailsCard from './AgencyDetailsCard.js'

function AgencyDetailsTable(data) {
    ...
    return (
        <>
            <AgencyDetailsCard applicationData={applicationData} />
        </>
    )
}
