...
//    Revision - 1
//    Project - JUIDCO
//    Component  - AgencyDocumentMailbox
//    DESCRIPTION - AgencyDocumentMailbox Component
//////////////////////////////////////////////////////////////////////////////////////


import { useState } from 'react'
import Modal from 'react-modal';
import AgencyDocumentRowMailbox from './AgencyDocumentRowMailbox.js';
...
function AgencyDocumentMailbox() {
                        ...
                        <div className="inline-block min-w-full rounded-lg overflow-hidden">
                            <table className="min-w-full leading-normal">
                                ...
                                <tbody>
                                    ...
                                    <AgencyDocumentRowMailbox openModal={modalAction} index="1" documentName="Aadhaar" status="Rejected" remarks="Document is not correct" />
                                    <AgencyDocumentRowMailbox openModal={modalAction} index="1" documentName="Aadhaar" status="Rejected" remarks="Document is not correct" />
                                    <AgencyDocumentRowMailbox openModal={modalAction} index="1" documentName="Aadhaar" status="Rejected" remarks="Document is not correct" />
                                    <AgencyDocumentRowMailbox openModal={modalAction} index="1" documentName="Aadhaar" status="Rejected" remarks="Document is not correct" />
...
export default AgencyDocumentMailbox