...
//    Revision - 1
//    Project - JUIDCO
//    Component  - SelfAdvrtDetailsCard
//    DESCRIPTION - SelfAdvrtDetailsCard Component
//////////////////////////////////////////////////////////////////////////////////////
...
import SelfAdvrtFullDetialsCard from './SelfAdvrtFullDetialsCard.js';
...
function SelfAdvrtDetailsCard(props) {
                            ...
                            <div className="bg-white p-3 border-t-4 border-green-400">
                                <div className="image overflow-hidden">
                                    <img className="h-auto w-full mx-auto"
                                        src="https://img.freepik.com/free-vector/brand-building-isometric-composition-with-women-entrepreneurs-team-online-advertising-website-desktop-screen-loudspeaker_1284-58544.jpg?w=740&t=st=1664014107~exp=1664014707~hmac=2652ad2a0de0e864d2f7f8eaaaf784e521513b02860b2b07d6fb519fd770823a"
                                        // src={propImage}
                                        alt="" />
                                </div>
                                <h1 className="text-gray-900 font-bold text-lg leading-8 my-1">Self Advertisement</h1>
                                <ul
                        ...
                        <div className="w-full md:w-9/12 mx-2 h-auto">
                            <div className="bg-white p-3 shadow-xl rounded-sm">
                                <div className="flex items-center pl-4 space-x-2 font-semibold text-gray-900 leading-8">
                                    ...
                                    <span className="tracking-wide">Application Detail</span>
                                </div>
...
export default SelfAdvrtDetailsCard
