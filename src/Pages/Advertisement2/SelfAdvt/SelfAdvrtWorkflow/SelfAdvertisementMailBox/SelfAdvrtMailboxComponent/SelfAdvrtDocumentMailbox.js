...
//    Revision - 1
//    Project - JUIDCO
//    Component  - SelfAdvrtDocumentMailbox
//    DESCRIPTION - SelfAdvrtDocumentMailbox Component
//////////////////////////////////////////////////////////////////////////////////////


import { useState } from 'react'
import Modal from 'react-modal';
import SelfAdvrtDocumentRowMailbox from './SelfAdvrtDocumentRowMailbox.js';
// import dummy from '../../../Components/MailboxComponent/dummy.pdf'
...
function SelfAdvrtDocumentMailbox() {
                        ...
                        <div className="inline-block min-w-full rounded-lg overflow-hidden">
                            <table className="min-w-full leading-normal">
                                ...
                                <tbody>
                                    ...
                                    <SelfAdvrtDocumentRowMailbox openModal={modalAction} index="1" documentName="Aadhaar" status="Rejected" remarks="Document is not correct" />
                                    <SelfAdvrtDocumentRowMailbox openModal={modalAction} index="1" documentName="Aadhaar" status="Rejected" remarks="Document is not correct" />
                                    <SelfAdvrtDocumentRowMailbox openModal={modalAction} index="1" documentName="Aadhaar" status="Rejected" remarks="Document is not correct" />
                                    <SelfAdvrtDocumentRowMailbox openModal={modalAction} index="1" documentName="Aadhaar" status="Rejected" remarks="Document is not correct" />
...
export default SelfAdvrtDocumentMailbox