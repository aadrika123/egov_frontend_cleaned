...
//    Revision - 1
//    Project - JUIDCO
//    Component  - SelfAdvrtListItems
//    DESCRIPTION - SelfAdvrtListItems Component
//////////////////////////////////////////////////////////////////////////////////////
...
import SelfAdvrtGlobalFilter from './SelfAdvrtGlobalFilter.js';

function SelfAdvrtListItems(props) {
    ...
    const [applicationLIst, setApplicationLIst] = useState([{ "id": 1, "tradeLicense_no": "6466244377", "entity_name": "Tiertza", "mobile": "0601669703", "property_type": "VACANT", "assessment_type": "New Assessment", "ward_no": 1, "received_at": "10/22/2021" },
    { "id": 2, "tradeLicense_no": "0880155833", "owner_name": "Maddalena", "mobile": "2494499119", "property_type": "INDEPENDENT", "assessment_type": "Mutation", "ward_no": 2, "received_at": "5/27/2022" }])
    ...
    return (
        <>
            <div className="flex mb-2 pb-2">
                <div className='flex-initial'><SelfAdvrtGlobalFilter filter={globalFilter} setFilter={setGlobalFilter} /></div>
...
export default SelfAdvrtListItems